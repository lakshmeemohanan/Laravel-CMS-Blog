...
<!-- Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      @include('components.admin.sidebar-post-links')
      @if(auth()->user()->userHasRole('Admin'))
        @include('components.admin.sidebar-user-links')
        @include('components.admin.authorization-links')
        @include('components.admin.contact-link')
        @include('components.admin.comments-link')
      @endif
    </ul>
    <!-- End of Sidebar -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Laravel CMS 2021</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
